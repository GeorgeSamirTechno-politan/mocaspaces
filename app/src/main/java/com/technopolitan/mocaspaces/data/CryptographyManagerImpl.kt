...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    private val encryptionBlocMode = KeyProperties.BLOCK_MODE_GCM
    ...
    private fun getCipher(): Cipher {
        val transformation = "$encryptionAlgorithm/$encryptionBlocMode/$encryptionPadding"
    ...
    private fun getOrCreateSecretKey(keyName: String): SecretKey {
        ...
        paramsBuilder.apply {
            setBlockModes(encryptionBlocMode)
