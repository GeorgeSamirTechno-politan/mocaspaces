...
class CheckEmailViewModel @Inject constructor(
    ...
    fun init(
        ...
        otpDataModule.initEmail(
            ...
            binding.otpEmailLayout.otpFirstEditText,
            binding.otpEmailLayout.otpSecondEditText,
            binding.otpEmailLayout.otpThirdEditText,
            binding.otpEmailLayout.otpFourthEditText,
