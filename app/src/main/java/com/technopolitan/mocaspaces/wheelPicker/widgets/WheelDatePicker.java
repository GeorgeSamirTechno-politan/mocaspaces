...
import com.technopolitan.mocaspaces.wheelPicker.IDebug;
import com.technopolitan.mocaspaces.wheelPicker.IWheelPicker;
...
//        mPickerDay.setMaximumWidthText("00");
    ...
    private int getSelectedMonth(String data){
        List<String> monthNames = Arrays.asList(getResources()
                .getStringArray(R.array.WheelMonthName));
        for (int i=0; i< monthNames.size();i++){
            if (Objects.equals(data, monthNames.get(i)))
                return i+ 1;
        }
        return 0;
    }
