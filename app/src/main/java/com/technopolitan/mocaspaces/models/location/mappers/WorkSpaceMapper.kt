...
//        val myCuurentLocation= LatLng().defaultInstanceForType.parserForType!!.
//        location?.let { distance = SphericalUtil.computeDistanceBetween(com.google.android.gms.maps.model.LatLng(
