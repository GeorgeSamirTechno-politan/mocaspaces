...
import com.technopolitan.mocaspaces.data.main.CustomBottomNavigationModule_Factory;
...
import com.technopolitan.mocaspaces.data.remote.DeleteWorkSpaceFavouriteRemote_Factory;
...
import com.technopolitan.mocaspaces.ui.home.meetingSpace.MeetingRoomViewModel_Factory;
...
import com.technopolitan.mocaspaces.ui.locationDetails.LocationDetailsViewModel_Factory;
...
import com.technopolitan.mocaspaces.ui.workspacePlans.WorkSpacePlansFragment_MembersInjector;
import com.technopolitan.mocaspaces.ui.workspacePlans.WorkSpacePlansViewModel;
import com.technopolitan.mocaspaces.ui.workspacePlans.WorkSpacePlansViewModel_Factory;
...
public final class DaggerApplicationComponent {
  ...
  private static final class ApplicationComponentImpl implements ApplicationComponent {
    ...
    private Provider<WorkSpaceDetailsRemote> workSpaceDetailsRemoteProvider;

    private Provider<LocationDetailsRepo> locationDetailsRepoProvider;
    ...
    private WorkSpaceAdapter workSpaceAdapter() {
      return new WorkSpaceAdapter(provideGlideModuleProvider.get(), context, provideSpannableStringModuleProvider.get());
    }
    ...
    private MeetingRoomAdapter meetingRoomAdapter() {
      return new MeetingRoomAdapter(provideGlideModuleProvider.get(), context);
    }
    ...
    private ApiResponseModule<List<WorkSpacePlanMapper>> apiResponseModuleOfListOfWorkSpacePlanMapper(
        ) {
    ...
    private void initialize(final AppModule appModuleParam, final Context contextParam,
      ...
      this.homeViewModelProvider = HomeViewModel_Factory.create(searchHintRemoteProvider, contextProvider);
      ...
      this.eventSpaceRemoteProvider = EventSpaceRemote_Factory.create(provideNetworkModelProvider, contextProvider, provideDateTimeModuleProvider, provideSpannableStringModuleProvider);
      ...
      this.bizLoungeRemoteProvider = BizLoungeRemote_Factory.create(provideNetworkModelProvider, provideDateTimeModuleProvider, contextProvider, provideSpannableStringModuleProvider);
    ...
    private WorkSpaceFragment injectWorkSpaceFragment(WorkSpaceFragment instance) {
      ...
      WorkSpaceFragment_MembersInjector.injectFavouriteApiHandler(instance, apiResponseModuleOfString());
      WorkSpaceFragment_MembersInjector.injectViewModelFactory(instance, viewModelFactoryProvider.get());
      WorkSpaceFragment_MembersInjector.injectNavigationModule(instance, provideNavigationModuleProvider.get());
      return instance;
    }
    ...
    private LocationDetailsFragment injectLocationDetailsFragment(
      ...
      LocationDetailsFragment_MembersInjector.injectGoogleMapModule(instance, googleMapModule());
      LocationDetailsFragment_MembersInjector.injectDetailsApiHandler(instance, apiResponseModuleOfLocationDetailsMapper());
